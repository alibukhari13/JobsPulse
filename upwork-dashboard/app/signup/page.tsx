  ...
  return (
    <div className="min-h-screen bg-page flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-surface border border-custom rounded-[2rem] p-8 shadow-2xl">
        ...
        <p className="text-secondary text-sm mb-8">Start managing your Upwork jobs</p>
        {error && (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-surface-light border border-custom rounded-xl p-4 pr-12 text-primary outline-none focus:border-accent transition"
                placeholder="••••••••"
                minLength={6}
              />
              <button
